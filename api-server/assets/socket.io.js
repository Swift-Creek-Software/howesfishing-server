      ...
      (function selfInvoking (cb){
        ...
        self.on('connect', function socketConnected() {
          ...
          consolog.noPrefix(
            ...
            '\n' +
              '<*)))<  aablesfishing.com  }-(((*>' +
              '              connected to the api server via sockets\n' +
              '    <")))><' +
              '                 mmmBooyah!' +
            ''
            // ' ⚓︎ (development mode)'
        ...
        self.on('reconnecting', function(numAttempts) {
          consolog(
            '\n'+
            '        Socket is trying to reconnect to server...\n'+
            '}-(((*>  (attempt #' + numAttempts + ')'+'\n'+
            '\n'
          );
        });
        ...
        self.on('reconnect', function(transport, numAttempts) {
          ...
          consolog(
            '\n'+
            '<*)))<  aablesfishing.com  }-(((*>' +
            '              re-connected to server after being disconnected for ' + numSecsOffline + ' seconds\n' +
            '    <")))><' +
            '                 mmmBooyah!' +
            '\n'
          );
